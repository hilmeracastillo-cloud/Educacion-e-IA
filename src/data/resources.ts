...
export const WORK_RESOURCES: ResourceItem[] = [
  ...
  },
  {
    ...
    description:
      'Deck visual estratégico completo en formato apaisado. Incluye el diagnóstico del rezago escolar, fundamentación tecno-pedagógica (Bloom 2 Sigma, BKT, IRT), matrices de desarrollo regional y arquitectura de las 7 Oportunidades con Nodos NEMA.',
    badge: '35 Diapositivas • Con Anexo',
    ...
    highlights: [
      '35 diapositivas completas actualizadas con anexo oficial',
      'Visor interactivo integrado para navegación slide a slide',
