      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 space-y-12">
        ...
        <section id="menu-opciones-obra" className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            {/* ===================================================== */}
            {/* 4-. Presentación sin audio (35 Diapositivas)           */}
            {/* ===================================================== */}
            <div className="rounded-2xl border border-amber-900/60 bg-[#16120b] hover:bg-[#1c160e] p-5 flex flex-col justify-between transition-all hover:border-amber-500/70 hover:shadow-xl group">
              <div className="space-y-3">
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                ...
                <p className="text-xs text-neutral-300 leading-relaxed">
                  Deck visual estratégico completo en formato apaisado. Detalla el diagnóstico de la crisis, fundamentos pedagógicos, matrices de desarrollo y la arquitectura de las 7 Oportunidades con Nodos NEMA.
                </p>

                <div className="pt-1 text-[11px] text-neutral-400 flex items-center gap-1.5 font-mono">
                  <span className="text-amber-400 font-bold">Longitud:</span>
                  <span>35 diapositivas (slides)</span>
                </div>
              </div>

              <div className="pt-4 mt-3 border-t border-amber-900/40 grid grid-cols-2 gap-2">
                <button
                  id="btn-landing-ver-slides"
                  onClick={() => setActivePresentationModal(true)}
                  className="py-2.5 px-2 rounded-xl bg-amber-950/80 hover:bg-amber-900 border border-amber-600/60 text-amber-200 font-semibold text-xs flex items-center justify-center gap-1.5 transition-all cursor-pointer"
                >
                  <Presentation className="w-3.5 h-3.5 text-amber-400" />
                  <span>Ver Slides (35)</span>
                </button>
                <button
                  id="btn-landing-descargar-slides"
                  onClick={() =>
                    handleDownloadFile(
                  ...
                  className="py-2.5 px-2 rounded-xl bg-[#1d2638] hover:bg-[#26334a] border border-[#334566] text-neutral-200 font-medium text-xs flex items-center justify-center gap-1.5 transition-all cursor-pointer"
                >
                  <Download className="w-3.5 h-3.5 text-cyan-400" />
                  <span>Descargar PDF</span>
                </button>
